            ...
            <div class="sidebar-left-info">
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    <li>
                        ...
                        <a href="/administrator/items/studio"><i class="fa fa-list"> </i> <span>Студии</span></a>
                        <a href="/administrator/items/designers"><i class="fa fa-list"> </i> <span>Дизайнеры</span></a>
                        <a href="/administrator/users"><i class="fa fa-list"> </i> <span>Пользователи</span></a>
                        <a href="/administrator/items/homeset"><i class="fa fa-list"> </i> <span>Настройка главной</span></a>
                        <a href="/administrator/settings"><i class="fa fa-list"> </i> <span>Настройки</span></a>
                    </li>
                </ul>
                <!--sidebar nav end-->
